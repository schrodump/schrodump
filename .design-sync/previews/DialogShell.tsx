...
export function DeleteArtifact() {
  return (
    <DialogShell
      ...
      subject={<SubjectRow state="UNOBSERVED" name="Acme Ledger" facts={["postgres · STREAM", "1.2 GB", "cm7k2p0q"]} />}
    ...
    >
      <Panel tone="danger" className="p-4">
        ...
        <ul className="mt-2 space-y-1 font-mono text-xs">
          <li>— the object org/acme-ledger/2026-09-09T18-46-12.archive</li>
          <li>— its manifest</li>
